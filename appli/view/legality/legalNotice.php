...
<div class="content">
    ...
    <p><strong>Copyright:</strong> All content published on this website, including text, images, videos, and other media, is protected by copyright laws. Copyrights to these contents belong to their respective creators unless otherwise stated. Contributors are required to respect copyright and only upload content for which they hold the rights or proper licenses.</p>

    <p><strong>Use of Content:</strong> Visitors are allowed to use the content on this website for educational, research, and reference purposes. However, any reproduction, distribution, or commercial use without prior authorization is strictly prohibited.</p>

    <p><strong>Disclaimer:</strong> While we strive to provide accurate and up-to-date information, we cannot guarantee the accuracy, completeness, or reliability of all the information available on this site. Visitors use the information provided at their own risk.</p>
