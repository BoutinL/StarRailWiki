...
INSERT INTO `eidolon` (`id_eidolon`, `nbr`, `name`, `effect`, `icon`, `image`, `playableCharacter_id`) VALUES
	...
	(3, 3, 'Poised', 'Skill Lv. +2, up to a maximum of Lv. 15 / Basic ATK Lv. +1, up to a maximum of Lv. 10.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/11d2ae7bbded23ca045ba40f3e63d970_1518491488393966864.png', NULL, 1),
	(4, 4, 'Dedication', 'When Himeko\'s Skill inflicts Weakness Break on an enemy, she gains 1 extra point(s) of Charge.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/706e50425fc52e5611db2eab1f605c1e_6006020162466853659.png', NULL, 1),
	(5, 5, 'Aspiration', 'Ultimate Lv. +2, up to a maximum of Lv. 15 / Talent Lv. +2, up to a maximum of Lv. 15.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/ec6121ff3e0894c51a8cc053131ef985_244646985592578051.png', NULL, 1),
	(6, 6, 'Trailblaze!', 'Ultimate deals DMG 2 extra times, each of which deals Fire DMG equal to 40% of the original DMG to a random enemy.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/987a996c0d08eb95f03125f856295357_6006020162466853659.png', NULL, 1),
	(7, 1, 'To the Bitter End', 'When HP is lower than or equal to 50% of Max HP, increases Skill\'s DMG by 10%.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/7b53600572dbb577e9103911f9cbead7_2317460015917781615.png', NULL, 13),
	(8, 2, 'Breaking Free', 'Using Skill or Ultimate removes 1 debuff from oneself.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/ae02d81d379f1659907dbe01eaef6f7b_5648732020738209033.png', NULL, 13),
	(9, 3, 'Power Through', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/d8c555f7f9f47b610f2a4b84678df64b_6744481196927712577.png', NULL, 13),
	...
	(11, 5, 'Hammer and Tongs', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/c1b168912e77cc9c91e1bce2eea9f36e_207187916340708054.png', NULL, 13),
	(12, 6, 'Self-Sacrifice', 'When HP drops to 50% or below, Ultimate deals 20% more DMG. The DMG multiplier of DMG taken by the target enemy now applies to adjacent enemies as well.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/67eb54c3e7dad91bc09b80036ecad201_889988161859419353.png', NULL, 13),
	(13, 1, 'The Higher You Fly, the Harder You Fall', 'When the target enemy\'s current HP percentage is greater than or equal to 50%, CRIT Rate increases by 12%.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/7881890e393b7dc872fcb6fc954ec12a_1746652745667222531.png', NULL, 5),
	(14, 2, 'Quell the Venom Octet, Quench the Vice O\'Flame', 'Reduces Talent cooldown by 1 turn.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/01e8258d8e4b33d12fa83b586531094b_1746652745667222531.png', NULL, 5),
	(15, 3, 'Seen and Unseen', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', 'https://upload-static.hoyoverse.com/hoyowiki/2023/02/21/6df4fcd5c070d21e9ff9cd64fb1594da_1518491488393966864.png', NULL, 5),
	...
	(64, 4, 'It\'s Okay to Not Know', 'When Talent is triggered, there is a 100% base chance to Burn enemies adjacent to the target enemy, equivalent to that of Skill.', NULL, NULL, 16),
	(65, 5, 'Let the Moles\' Deeds Be Known', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 16),
	(66, 6, 'Always Ready to Punch and Kick', 'Hook deals 20% more DMG to enemies afflicted with Burn.', NULL, NULL, 16),
	(67, 1, 'Slash, Seas Split', 'When Lightning-Lord attacks, the DMG multiplier on enemies adjacent to the target enemy increases by an extra amount equal to 25% of the DMG multiplier against the target enemy.', NULL, NULL, 8),
	(68, 2, 'Swing, Skies Squashed', 'After Lightning-Lord takes action, DMG caused by Jing Yuan\'s Basic ATK, Skill, and Ultimate increases by 20% for 2 turn(s).', NULL, NULL, 8),
	(69, 3, 'Strike, Suns Subdued', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 8),
	(70, 4, 'Spin, Stars Sieged', 'For each hit performed by the Lightning-Lord when it takes action, Jing Yuan regenerates 2 Energy.', NULL, NULL, 8),
	(71, 5, 'Stride, Spoils Seized', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 8),
	(72, 6, 'Sweep, Souls Slain', 'Each hit performed by the Lightning-Lord when it takes action will make the target enemy Vulnerable.\r\nWhile Vulnerable, enemies receive 12% more DMG until the end of the Lightning-Lord\'s current turn, stacking up to 3 time(s).', NULL, NULL, 8),
	(73, 1, 'Da Capo', 'When the Talent triggers a follow-up attack, there is a 100% base chance to increase the DoT received by the target by 30% for 2 turn(s).', NULL, NULL, 4),
	(74, 2, 'Fortississimo', 'While Kafka is on the field, DoT dealt by all allies increases by 25%.', NULL, NULL, 4),
	(75, 3, 'Capriccio', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 4),
	(76, 4, 'Recitativo', 'When an enemy target takes DMG from the Shock status inflicted by Kafka, Kafka additionally regenerates 2 Energy.', NULL, NULL, 4),
	(77, 5, 'Doloroso', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 4),
	(78, 6, 'Leggiero', 'The Shock inflicted on the enemy target by the Ultimate, the Technique, or the Talent-triggered follow-up attack has a DMG multiplier increase of 156% and lasts 1 turn(s) longer.', NULL, NULL, 4),
	(79, 1, 'Fighting Endlessly', 'When Luka takes action, if the target enemy is Bleeding, increases DMG dealt by Luka by 15% for 2 turn(s).', NULL, NULL, 17),
	(80, 2, 'The Enemy is Weak, I am Strong', 'If the Skill hits an enemy target with Physical Weakness, gain 1 stack(s) of Fighting Will.', NULL, NULL, 17),
	(81, 3, 'Born for the Ring', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 17),
	(82, 4, 'Never Turning Back', 'For every stack of Fighting Will obtained, increases ATK by 5%, stacking up to 4 time(s).', NULL, NULL, 17),
	(83, 5, 'The Spirit of Wildfire', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 17),
	(84, 6, 'A Champion\'s Applause', 'After the Enhanced Basic ATK\'s "Rising Uppercut" hits a Bleeding enemy target, the Bleed status will immediately deal DMG 1 time equal to 8% of the original DMG for every hit of Direct Punch already unleashed during the current Enhanced Basic ATK.', NULL, NULL, 17),
	(85, 1, 'Ablution of the Quick', 'While the Field is active, ATK of all allies increases by 20%.', NULL, NULL, 27),
	(86, 2, 'Bestowal From the Pure', 'When his Skill is triggered, if the target ally\'s HP is lower than 50%, Luocha\'s Outgoing Healing increases by 30%. If the target ally\'s HP is at 50% or higher, the ally receives a Shield that can absorb DMG equal to 10% of Luocha\'s ATK plus 240, lasting for 2 turns.', NULL, NULL, 27),
	(87, 3, 'Surveyal by the Fool', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 27),
	(88, 4, 'Heavy Lies the Crown', 'When Luocha\'s Field is active, enemies become Weakened and deal 12% less DMG.', NULL, NULL, 27),
	(89, 5, 'Cicatrix \'Neath the Pain', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 27),
	(90, 6, 'Reunion With the Dust', 'When Ultimate is used, there is a 100% fixed chance to reduce all enemies\' All-Type RES by 20% for 2 turn(s).', NULL, NULL, 27),
	(91, 1, 'Memory of You', 'Every time March 7th\'s Ultimate Freezes a target, she regenerates 6 Energy.', NULL, NULL, 2),
	(92, 2, 'Memory of It', 'Upon entering battle, grants a Shield equal to 24% of March 7th\'s DEF plus 320 to the ally with the lowest HP percentage, lasting for 3 turn(s).', NULL, NULL, 2),
	(93, 3, 'Memory of Everything', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 2),
	(94, 4, 'Never Forfeit Again', 'The Talent\'s Counter effect can be triggered 1 more time in each turn. The DMG dealt by Counter increases by an amount that is equal to 30% of March 7th\'s DEF.', NULL, NULL, 2),
	(95, 5, 'Never Forget Again', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 2),
	(96, 6, 'Just Like This, Always...', 'Allies under the protection of the Shield granted by the Skill restores HP equal to 4% of their Max HP plus 106 at the beginning of each turn.', NULL, NULL, 2),
	(97, 1, 'Pharmacology Expertise', 'After being attacked, if the current HP percentage is 30% or lower, heals self for 1 time to restore HP by an amount equal to 15% of Max HP plus 400. This effect can only be triggered 1 time per battle.', NULL, NULL, 18),
	(98, 2, 'Clinical Research', 'When Natasha uses her Ultimate, grant continuous healing for 1 turn(s) to all allies whose HP is at 30% or lower. And at the beginning of their turn, their HP is restored by an amount equal to 6% of Natasha\'s Max HP plus 160.', NULL, NULL, 18),
	(99, 3, 'The Right Cure', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 18),
	(100, 4, 'Miracle Cure', 'After being attacked, regenerates 5 extra Energy.', NULL, NULL, 18),
	(101, 5, 'Preventive Treatment', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 18),
	(102, 6, 'Doctor\'s Grace', 'Natasha\'s Basic ATK deals Additional Physical DMG equal to 40% of her Max HP.', NULL, NULL, 18),
	(103, 1, 'Victory Report', 'When an enemy is defeated, Pela regenerates 5 Energy.', NULL, NULL, 19),
	(104, 2, 'Adamant Charge', 'Using Skill to remove buff(s) increases SPD by 10% for 2 turn(s).', NULL, NULL, 19),
	(105, 3, 'Suppressive Force', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 19),
	(106, 4, 'Full Analysis', 'When using Skill, there is a 100% base chance to reduce the target enemy\'s Ice RES by 12% for 2 turn(s).', NULL, NULL, 19),
	(107, 5, 'Absolute Jeopardy', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 19),
	(108, 6, 'Feeble Pursuit', 'When Pela attacks a debuffed enemy, she deals Additional Ice DMG equal to 40% of Pela\'s ATK to the enemy.', NULL, NULL, 19),
	(109, 1, 'Rise Through the Tiles', 'Ultimate deals 10% more DMG.', NULL, NULL, 23),
	(110, 2, 'Sleep on the Tiles', 'Every time Draw Tile is triggered, Qingque immediately regenerates 1 Energy.', NULL, NULL, 23),
	(111, 3, 'Read Between the Tiles', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 23),
	(112, 4, 'Right on the Tiles', 'After this character\'s Skill is used, there is a 24% fixed chance to gain Autarky, which lasts until the end of the current turn.\r\nWith Autarky, using Basic ATK or Enhanced Basic ATK immediately launches 1 follow-up attack on the same target, dealing Quantum DMG equal to 100% of the previous Basic ATK (or Enhanced Basic ATK)\'s DMG.', NULL, NULL, 23),
	(113, 5, 'Gambit for the Tiles', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 23),
	(114, 6, 'Prevail Beyond the Tiles', 'Recovers 1 Skill Point after using Enhanced Basic ATK.', NULL, NULL, 23),
	(115, 1, 'Rising Love', 'When using Skill, deals DMG for 1 extra time(s) to a random enemy.', NULL, NULL, 20),
	(116, 2, 'Infectious Enthusiasm', 'Defeating an enemy with Wind Shear has a 100% base chance to inflict all enemies with 1 stack(s) of Wind Shear, equivalent to the Talent\'s Wind Shear.', NULL, NULL, 20),
	(117, 3, 'Big Money!', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 20),
	(118, 4, 'The Deeper the Love, the Stronger the Hate', 'When Skill hits an enemy with 5 or more stack(s) of Wind Shear, the enemy immediately takes 8% of current Wind Shear DMG.', NULL, NULL, 20),
	(119, 5, 'Huuuuge Money!', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 20),
	(120, 6, '	Increased Spending', 'Talent\'s Wind Shear DMG multiplier increases by 15%.', NULL, NULL, 20),
	(121, 1, 'Extirpating Slash', 'When dealing DMG to an enemy whose HP percentage is 80% or lower, CRIT Rate increases by 15%.', NULL, NULL, 9),
	(122, 2, 'Dancing Butterfly', 'The SPD Boost effect of Seele\'s Skill can stack up to 2 time(s).', NULL, NULL, 9),
	(123, 3, 'Dazzling Tumult', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 9),
	(124, 4, 'Flitting Phantasm', 'Seele regenerates 15 Energy when she defeats an enemy.', NULL, NULL, 9),
	(125, 5, 'Piercing Shards', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 9),
	(126, 6, 'Shattering Shambles', 'After Seele uses her Ultimate, inflict the target enemy with Butterfly Flurry for 1 turn(s). Enemies suffering from Butterfly Flurry will take Additional Quantum DMG equal to 15% of Seele\'s Ultimate DMG every time they are attacked. If the target enemy is defeated by the Butterfly Flurry DMG triggered by other allies\' attacks, Seele\'s Talent will not be triggered.\r\nWhen Seele is knocked down, the Butterfly Flurry inflicted on the enemies will be removed.', NULL, NULL, 9),
	(127, 1, 'Echo Chamber', 'Basic ATK deals Lightning DMG equal to 60% of the Basic ATK\'s DMG to a random enemy adjacent to the target of the Basic ATK.', NULL, NULL, 21),
	(128, 2, 'Encore!', 'Every time Serval\'s Talent is triggered to deal Additional DMG, she regenerates 4 Energy.', NULL, NULL, 21),
	(129, 3, 'Listen, the Heartbeat of the Gears', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 21),
	(130, 4, 'Make Some Noise!', 'Ultimate has a 100% base chance to apply Shock to any enemies not currently Shocked. This Shock has the same effects as the one applied by Skill.', NULL, NULL, 21),
	(131, 5, 'Belobog\'s Loudest Roar!', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 21),
	(132, 6, 'This Song Rocks to Heaven!', 'Serval deals 30% more DMG to Shocked enemies.', NULL, NULL, 21),
	(133, 1, 'Social Engineering', 'After using her Ultimate to attack enemies, Silver Wolf regenerates 7 Energy for every debuff that the target enemy currently has. This effect can be triggered up to 5 time(s) in each use of her Ultimate.', NULL, NULL, 12),
	(134, 2, 'Zombie Network', 'When an enemy enters battle, reduces their Effect RES by 20%.', NULL, NULL, 12),
	(135, 3, 'Payload', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 12),
	(136, 4, 'Bounce Attack', 'After using her Ultimate to attack enemies, deals Additional Quantum DMG equal to 20% of Silver Wolf\'s ATK for every debuff currently on the enemy target. This effect can be triggered for a maximum of 5 time(s) during each use of her Ultimate.', NULL, NULL, 12),
	(137, 5, 'Brute Force Attack', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 12),
	(138, 6, 'Overlay Network', 'For every debuff the target enemy has, the DMG dealt by Silver Wolf increases by 20%, up to a limit of 100%.', NULL, NULL, 12),
	(139, 1, 'Cut With Ease', 'After using Skill against a Weakness Broken enemy, regenerates 1 Skill Point.', NULL, NULL, 24),
	(140, 2, 'Refine in Toil', 'After triggering Sword Stance, the DMG taken by Sushang is reduced by 20% for 1 turn.', NULL, NULL, 24),
	(141, 3, 'Rise From Fame', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 24),
	(142, 4, 'Cleave With Heart', 'Sushang\'s Break Effect increases by 40%.', NULL, NULL, 24),
	(143, 5, 'Prevail via Taixu', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 24),
	(144, 6, 'Dwell Like Water', 'Talent\'s SPD Boost is stackable and can stack up to 2 times. Additionally, after entering battle, Sushang immediately gains 1 stack of her Talent\'s SPD Boost.', NULL, NULL, 24),
	(145, 1, 'Windfall of Lucky Springs', 'After using their Ultimate, the ally with Benediction gains a 12% increase in SPD for 1 turn.', NULL, NULL, 25),
	(146, 2, 'Gainfully Gives, Givingly Gains', 'The ally with Benediction regenerates 5 Energy after defeating an enemy. This effect can only be triggered once per turn.', NULL, NULL, 25),
	(147, 3, 'Halcyon Bequest', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 25),
	(148, 4, 'Jovial Versatility', 'The DMG multiplier provided by Benediction increases by 20%.', NULL, NULL, 25),
	(149, 5, 'Sauntering Coquette', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 25),
	(150, 6, 'Peace Brings Wealth to All', 'Ultimate regenerates 10 more Energy for the target ally.', NULL, NULL, 25),
	(151, 1, 'Legacy of Honor', 'After Welt uses his Ultimate, his abilities are enhanced. The next 2 time(s) he uses his Basic ATK or Skill, deals Additional DMG to the target equal to 50% of his Basic ATK\'s DMG multiplier or 80% of his Skill\'s DMG multiplier respectively.', NULL, NULL, 6),
	(152, 2, 'Conflux of Stars', 'When his Talent is triggered, Welt regenerates 3 Energy.', NULL, NULL, 6),
	(153, 3, 'Prayer of Peace', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 6),
	(154, 4, 'Appellation of Justice', 'Base chance for Skill to inflict SPD Reduction increases by 35%.', NULL, NULL, 6),
	(155, 5, 'Power of Kindness', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 6),
	(156, 6, 'Prospect of Glory', 'When using Skill, deals DMG for 1 extra time to a random enemy.', NULL, NULL, 6),
	(157, 1, 'Svelte Saber', 'When Yanqing attacks a Frozen enemy, he deals Additional Ice DMG equal to 60% of his ATK.', NULL, NULL, 28),
	(158, 2, 'Supine Serenade', 'When Soulsteel Sync is active, Energy Regeneration Rate increases by an extra 10%.', NULL, NULL, 28),
	(159, 3, 'Sword Savant', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 28),
	(160, 4, 'Searing Sting', 'When the current HP percentage is 80% or higher, Ice RES PEN increases by 12%', NULL, NULL, 28),
	(161, 5, 'Surging Strife', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 28),
	(162, 6, 'Swift Swoop', 'If the Ultimate\'s buffs are still in effect when an enemy is defeated, their duration is extended by 1 turn.', NULL, NULL, 28),
	(163, 1, 'Aerial Marshal', 'At the start of battle, increases the SPD of all allies by 10% for 2 turn(s).', NULL, NULL, 26),
	(164, 2, 'Skyward Command', 'When any ally\'s current energy is equal to its energy limit, Yukong regenerates an additional 5 energy. This effect can only be triggered once for each ally. The trigger count is reset after Yukong casts her Ultimate.', NULL, NULL, 26),
	(165, 3, '	Torrential Fusillade', 'Skill Lv. +2, up to a maximum of Lv. 15. Basic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 26),
	(166, 4, 'Zephyrean Echoes', 'When "Roaring Bowstrings" is active, Yukong deals 30% more DMG to enemies.', NULL, NULL, 26),
	(167, 5, 'August Deadshot', 'Ultimate Lv. +2, up to a maximum of Lv. 15. Talent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 26),
	(168, 6, 'Bowstring Thunderclap', 'When Yukong uses her Ultimate, she immediately gains 1 stack(s) of "Roaring Bowstrings."', NULL, NULL, 26),
	(169, 1, 'A Falling Star', 'When enemies are defeated due to the Trailblazer\'s Ultimate, the Trailblazer regenerates 10 extra Energy. This effect can only be triggered once per attack.', NULL, NULL, 29),
	(170, 2, 'An Unwilling Host', 'Attacking enemies with Physical Weakness restores the Trailblazer\'s HP equal to 5% of the Trailblazer\'s ATK.', NULL, NULL, 29),
	(171, 3, 'A Leading Whisper', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 29),
	(172, 4, 'A Destructing Glance', 'When attacking an enemy with Weakness Break, CRIT Rate is increased by 25%.', NULL, NULL, 29),
	(173, 5, 'A Surviving Hope', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 29),
	(174, 6, 'A Trailblazing Will', 'The Trailblazer\'s Talent is also triggered when they defeat an enemy.', NULL, NULL, 29),
	(175, 1, 'Earth-Shaking Resonance', 'When the Trailblazer uses their Basic ATK, additionally deals Fire DMG equal to 25% of the Trailblazer\'s DEF. When the Trailblazer uses their enhanced Basic ATK, deal Fire Additional DMG equal to 50% of the Trailblazer\'s DEF.', NULL, NULL, 30),
	(176, 2, 'Time-Defying Tenacity', 'The Shield applied to all allies from the Trailblazer\'s Talent will block extra DMG equal to 2% of the Trailblazer\'s DEF plus 27.', NULL, NULL, 30),
	(177, 3, 'Trail-Blazing Blueprint', 'Skill Lv. +2, up to a maximum of Lv. 15.\r\nTalent Lv. +2, up to a maximum of Lv. 15.', NULL, NULL, 30),
	(178, 4, 'Nation-Building Oath', 'At the start of the battle, immediately gains 4 stack(s) of Magma Will.', NULL, NULL, 30),
	(179, 5, 'Spirit-Warming Flame', 'Ultimate Lv. +2, up to a maximum of Lv. 15.\r\nBasic ATK Lv. +1, up to a maximum of Lv. 10.', NULL, NULL, 30),
	(180, 6, 'City-Forging Bulwarks', 'After the Trailblazer use enhanced Basic ATK or Ultimate, their DEF increases by 10%. Stacks up to 3 time(s).', NULL, NULL, 30);
